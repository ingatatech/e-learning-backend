...
// Middleware
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:8000', 'https://e-learning-yixk.onrender.com', 'https://e-learning-backend-v7pk.onrender.com', 'https://e-learning-backend-1-3zm4.onrender.com'],
